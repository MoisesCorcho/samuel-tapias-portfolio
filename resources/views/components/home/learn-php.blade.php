<x-call-to-action>
  <x-slot:title>
    ...
    <x-button-link href="" variant="dark" class="mr-3 w-full mb-3 text-center lg:w-auto" target="_blank">
      View on Github
    </x-button-link>
    <x-button-link class="mr-3 w-full mb-3 text-center lg:w-auto" href="" variant="red" target="_blank">
      Watch on YouTube
    </x-button-link>
</x-call-to-action>
